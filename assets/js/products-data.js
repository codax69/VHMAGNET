const PRODUCTS = [
  // ─── MAGNETS ─────────────────────────────────
  {
    ...
    name: "Photo Magnet",
    category: "magnet",
    image: "assets/public/fridge magnet.jpeg",
    ...
    sizes: [
      ...
      { label: "5×5 inch", value: "5x5 inch", price: 125 },
    ],
    features: [
  ...
  },
  {
    ...
    category: "magnet",
    image: "assets/public/fridge magnet1.jpeg",
    ...
    startingPrice: 80,
    sizes: [
      { label: "2×2 inch (set of 4)", value: "2x2 inch set", price: 80 },
      { label: "3×3 inch (set of 4)", value: "3x3 inch set", price: 180 },
    ],
    features: [
  ...
  },
  {
    ...
    name: "Couple Magnet",
    category: "magnet",
    image: "assets/public/happyanniversary.jpeg",
    ...
    startingPrice: 45,
    sizes: [
      { label: "3×3 inch Heart", value: "3x3 inch", price: 45 },
      { label: "4×4 inch Heart", value: "4x4 inch", price: 80 },
      { label: "5×5 inch Heart", value: "5x5 inch", price: 125 },
    ],
    features: [
  ...
  },
  {
    ...
    sizes: [
      { label: "3×3 inch", value: "3x3 inch", price: 45 },
      { label: "4×4 inch", value: "4x4 inch", price: 80 },
      { label: "5×7 inch", value: "5x7 inch", price: 175 },
    ],
    features: [
  ...
  },
  {
    ...
    category: "magnet",
    image: "assets/public/happybrithday.jpeg",
    ...
    sizes: [
      { label: "3×3 inch", value: "3x3 inch", price: 45 },
      { label: "4×4 inch", value: "4x4 inch", price: 80 },
      { label: "5×5 inch Round", value: "5x5 inch round", price: 125 },
    ],
    features: [
  ...
  // ─── STICKERS ────────────────────────────────
  {
    ...
    name: "Custom Sticker",
    category: "sticker",
    image: "assets/public/book sticker.jpeg",
    ...
    sizes: [
      ...
      { label: "3×3 inch", value: "3x3 inch", price: 45 },
      { label: "A5 Sheet", value: "A5 Sheet", price: 215 },
    ],
    features: [
  ...
  },
  {
    ...
    sizes: [
      { label: "3×3 inch", value: "3x3 inch", price: 45 },
      { label: "4×4 inch", value: "4x4 inch", price: 80 },
      { label: "6×4 inch (Landscape)", value: "6x4 inch", price: 120 },
    ],
    features: [
  ...
  },
  {
    ...
    sizes: [
      { label: "4×4 inch", value: "4x4 inch", price: 80 },
      { label: "6×4 inch", value: "6x4 inch", price: 120 },
      { label: "8×4 inch (Bumper)", value: "8x4 inch", price: 160 },
    ],
    features: [
  ...
  },
  {
    ...
    category: "sticker",
    image: "assets/public/1120037a-1.png",
    ...
    startingPrice: 200,
    sizes: [
      { label: "2×2 inch (10 pcs)", value: "2x2 inch x10", price: 200 },
      { label: "3×3 inch (10 pcs)", value: "3x3 inch x10", price: 450 },
      { label: "4×4 inch (10 pcs)", value: "4x4 inch x10", price: 800 },
    ],
    features: [
  ...
  },
  {
    ...
    startingPrice: 100,
    sizes: [
      { label: "Small Pack (20 pcs)", value: "Small Pack 20pcs", price: 100 },
      { label: "Medium Pack (40 pcs)", value: "Medium Pack 40pcs", price: 200 },
      { label: "Large Pack (80 pcs)", value: "Large Pack 80pcs", price: 400 },
    ],
    features: [
